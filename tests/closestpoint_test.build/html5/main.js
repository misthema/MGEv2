...
c_Game.m_new=function(){
	push_err();
	err_info="C:/MonkeyX77a/modules/mgev2/tests/closestpoint_test.monkey<10>";
...
c_Game.prototype.p_OnCreate=function(){
	push_err();
	err_info="C:/MonkeyX77a/modules/mgev2/tests/closestpoint_test.monkey<19>";
	bb_app_SetUpdateRate(60);
	err_info="C:/MonkeyX77a/modules/mgev2/tests/closestpoint_test.monkey<21>";
	this.m_mouse=c_Vector.m_new.call(new c_Vector,0.0,0.0);
	err_info="C:/MonkeyX77a/modules/mgev2/tests/closestpoint_test.monkey<22>";
	this.m_segment=c_Segment.m_new.call(new c_Segment,200.0,200.0,400.0,300.0);
	err_info="C:/MonkeyX77a/modules/mgev2/tests/closestpoint_test.monkey<23>";
	this.m_result=c_Vector.m_new.call(new c_Vector,0.0,0.0);
	err_info="C:/MonkeyX77a/modules/mgev2/tests/closestpoint_test.monkey<25>";
	pop_err();
	return 0;
}
c_Game.prototype.p_OnUpdate=function(){
	push_err();
	err_info="C:/MonkeyX77a/modules/mgev2/tests/closestpoint_test.monkey<31>";
	this.m_mouse.p_Set(bb_input_MouseX(),bb_input_MouseY());
	err_info="C:/MonkeyX77a/modules/mgev2/tests/closestpoint_test.monkey<32>";
	this.m_segment.p_GetClosestPoint(this.m_mouse,this.m_result);
	err_info="C:/MonkeyX77a/modules/mgev2/tests/closestpoint_test.monkey<34>";
	pop_err();
	return 0;
}
c_Game.prototype.p_OnRender=function(){
	push_err();
	err_info="C:/MonkeyX77a/modules/mgev2/tests/closestpoint_test.monkey<39>";
	bb_graphics_Cls(0.0,0.0,0.0);
	err_info="C:/MonkeyX77a/modules/mgev2/tests/closestpoint_test.monkey<41>";
	bb_graphics_SetColor(0.0,255.0,0.0);
	err_info="C:/MonkeyX77a/modules/mgev2/tests/closestpoint_test.monkey<42>";
	bb_graphics_DrawLine(dbg_object(dbg_object(this.m_segment).m_p1).m_x,dbg_object(dbg_object(this.m_segment).m_p1).m_y,dbg_object(dbg_object(this.m_segment).m_p2).m_x,dbg_object(dbg_object(this.m_segment).m_p2).m_y);
	err_info="C:/MonkeyX77a/modules/mgev2/tests/closestpoint_test.monkey<44>";
	bb_graphics_SetColor(255.0,255.0,255.0);
	err_info="C:/MonkeyX77a/modules/mgev2/tests/closestpoint_test.monkey<45>";
	bb_graphics_DrawCircle(dbg_object(this.m_result).m_x,dbg_object(this.m_result).m_y,3.0);
	err_info="C:/MonkeyX77a/modules/mgev2/tests/closestpoint_test.monkey<46>";
	bb_graphics_DrawCircle(dbg_object(this.m_mouse).m_x,dbg_object(this.m_mouse).m_y,3.0);
	err_info="C:/MonkeyX77a/modules/mgev2/tests/closestpoint_test.monkey<48>";
	pop_err();
	return 0;
}
c_Game.prototype.p_OnLoading=function(){
	push_err();
	err_info="C:/MonkeyX77a/modules/mgev2/tests/closestpoint_test.monkey<54>";
	pop_err();
	return 0;
}
c_Game.prototype.p_OnSuspend=function(){
	push_err();
	err_info="C:/MonkeyX77a/modules/mgev2/tests/closestpoint_test.monkey<68>";
	pop_err();
	return 0;
}
c_Game.prototype.p_OnResume=function(){
	push_err();
	err_info="C:/MonkeyX77a/modules/mgev2/tests/closestpoint_test.monkey<74>";
	pop_err();
	return 0;
}
c_Game.prototype.p_OnClose=function(){
	push_err();
	err_info="C:/MonkeyX77a/modules/mgev2/tests/closestpoint_test.monkey<82>";
...
c_Game.prototype.p_OnBack=function(){
	push_err();
	err_info="C:/MonkeyX77a/modules/mgev2/tests/closestpoint_test.monkey<88>";
...
function bbMain(){
	push_err();
	err_info="C:/MonkeyX77a/modules/mgev2/tests/closestpoint_test.monkey<6>";
	c_Game.m_new.call(new c_Game);
	err_info="C:/MonkeyX77a/modules/mgev2/tests/closestpoint_test.monkey<7>";
	pop_err();
	return 0;
}
...
c_Segment.prototype.p_GetClosestPoint=function(t_point,t_result){
	...
	err_info="C:/MonkeyX77a/modules/mgev2/src/utils/geom/segment.monkey<72>";
	this.m_vec=c_Vector.m_MakeBetween(this.m_p2,this.m_p1);
	err_info="C:/MonkeyX77a/modules/mgev2/src/utils/geom/segment.monkey<74>";
	var t_amt=this.m_vec.p_ProjectionAmount(this.m_localTemp);
	err_info="C:/MonkeyX77a/modules/mgev2/src/utils/geom/segment.monkey<76>";
	t_amt=bb_math2_Min2(1.0,bb_math2_Max2(0.0,t_amt));
	err_info="C:/MonkeyX77a/modules/mgev2/src/utils/geom/segment.monkey<87>";
	t_result.p_Set2(this.m_p1.p_Add2(this.m_vec.p_Multiply2(t_amt)));
	pop_err();
}

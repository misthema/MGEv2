...
function c_Game(){
	...
	this.m_bVec=null;
	this.m_b=null;
	this.m_intersects=false;
	this.m_distance=.0;
}
c_Game.prototype=extend_class(c_App);
c_Game.m_new=function(){
	push_err();
	err_info="C:/MonkeyX77a/modules/mgev2/tests/lineintersection test.monkey<10>";
...
c_Game.prototype.p_OnCreate=function(){
	push_err();
	err_info="C:/MonkeyX77a/modules/mgev2/tests/lineintersection test.monkey<21>";
	bb_app_SetUpdateRate(60);
	err_info="C:/MonkeyX77a/modules/mgev2/tests/lineintersection test.monkey<23>";
	this.m_a=c_Segment.m_new2.call(new c_Segment,c_Vector.m_new.call(new c_Vector,100.0,100.0),c_Vector.m_new.call(new c_Vector,300.0,200.0));
	err_info="C:/MonkeyX77a/modules/mgev2/tests/lineintersection test.monkey<25>";
	this.m_mouse=c_Vector.m_new.call(new c_Vector,bb_input_MouseX(),bb_input_MouseY());
	err_info="C:/MonkeyX77a/modules/mgev2/tests/lineintersection test.monkey<26>";
	this.m_constVec=c_Vector.m_new.call(new c_Vector,100.0,-50.0);
	err_info="C:/MonkeyX77a/modules/mgev2/tests/lineintersection test.monkey<27>";
	this.m_bVec=this.m_constVec.p_Add2(this.m_mouse);
	err_info="C:/MonkeyX77a/modules/mgev2/tests/lineintersection test.monkey<28>";
	this.m_b=c_Segment.m_new2.call(new c_Segment,this.m_mouse,this.m_bVec);
	err_info="C:/MonkeyX77a/modules/mgev2/tests/lineintersection test.monkey<31>";
	pop_err();
	return 0;
}
c_Game.prototype.p_OnUpdate=function(){
	push_err();
	err_info="C:/MonkeyX77a/modules/mgev2/tests/lineintersection test.monkey<36>";
	this.m_mouse.p_Set4(bb_input_MouseX(),bb_input_MouseY());
	err_info="C:/MonkeyX77a/modules/mgev2/tests/lineintersection test.monkey<37>";
	this.m_bVec=this.m_constVec.p_Add2(this.m_mouse);
	err_info="C:/MonkeyX77a/modules/mgev2/tests/lineintersection test.monkey<39>";
	if((bb_input_KeyDown(1))!=0){
		err_info="C:/MonkeyX77a/modules/mgev2/tests/lineintersection test.monkey<39>";
		var t_=this.m_constVec;
		this.m_constVec.p_Angle2(t_.p_Angle()+1.0);
	}
	err_info="C:/MonkeyX77a/modules/mgev2/tests/lineintersection test.monkey<40>";
	if((bb_input_KeyDown(2))!=0){
		err_info="C:/MonkeyX77a/modules/mgev2/tests/lineintersection test.monkey<40>";
		var t_2=this.m_constVec;
		this.m_constVec.p_Angle2(t_2.p_Angle()-1.0);
	}
	err_info="C:/MonkeyX77a/modules/mgev2/tests/lineintersection test.monkey<42>";
	this.m_b.p_Set2(this.m_mouse,this.m_bVec);
	err_info="C:/MonkeyX77a/modules/mgev2/tests/lineintersection test.monkey<44>";
	this.m_intersects=this.m_a.p_Intersects(this.m_b);
	err_info="C:/MonkeyX77a/modules/mgev2/tests/lineintersection test.monkey<46>";
	this.m_distance=this.m_a.p_DistanceTo2(this.m_b);
	err_info="C:/MonkeyX77a/modules/mgev2/tests/lineintersection test.monkey<48>";
	pop_err();
	return 0;
}
c_Game.prototype.p_OnRender=function(){
	push_err();
	err_info="C:/MonkeyX77a/modules/mgev2/tests/lineintersection test.monkey<53>";
	bb_graphics_Cls(0.0,0.0,0.0);
	err_info="C:/MonkeyX77a/modules/mgev2/tests/lineintersection test.monkey<55>";
	var t_1=this.m_intersects;
	err_info="C:/MonkeyX77a/modules/mgev2/tests/lineintersection test.monkey<56>";
	if(t_1==true){
		err_info="C:/MonkeyX77a/modules/mgev2/tests/lineintersection test.monkey<57>";
		bb_graphics_SetColor(255.0,0.0,0.0);
		err_info="C:/MonkeyX77a/modules/mgev2/tests/lineintersection test.monkey<58>";
		bb_graphics_DrawText("Intersection ("+String(dbg_object(dbg_object(this.m_a).m_intersection).m_x).slice(0,5)+", "+String(dbg_object(dbg_object(this.m_a).m_intersection).m_y).slice(0,5)+")",2.0,468.0,0.0,0.0);
	}else{
		err_info="C:/MonkeyX77a/modules/mgev2/tests/lineintersection test.monkey<59>";
		if(t_1==false){
			err_info="C:/MonkeyX77a/modules/mgev2/tests/lineintersection test.monkey<60>";
			bb_graphics_SetColor(0.0,255.0,0.0);
			err_info="C:/MonkeyX77a/modules/mgev2/tests/lineintersection test.monkey<61>";
			bb_graphics_DrawText("No intersection",2.0,468.0,0.0,0.0);
		}
	}
	err_info="C:/MonkeyX77a/modules/mgev2/tests/lineintersection test.monkey<63>";
	bb_graphics_DrawLine(dbg_object(dbg_object(this.m_a).m_p1).m_x,dbg_object(dbg_object(this.m_a).m_p1).m_y,dbg_object(dbg_object(this.m_a).m_p2).m_x,dbg_object(dbg_object(this.m_a).m_p2).m_y);
	err_info="C:/MonkeyX77a/modules/mgev2/tests/lineintersection test.monkey<64>";
	bb_graphics_DrawLine(dbg_object(dbg_object(this.m_b).m_p1).m_x,dbg_object(dbg_object(this.m_b).m_p1).m_y,dbg_object(dbg_object(this.m_b).m_p2).m_x,dbg_object(dbg_object(this.m_b).m_p2).m_y);
	err_info="C:/MonkeyX77a/modules/mgev2/tests/lineintersection test.monkey<68>";
	bb_graphics_SetColor(255.0,255.0,255.0);
	err_info="C:/MonkeyX77a/modules/mgev2/tests/lineintersection test.monkey<69>";
	if(this.m_intersects){
		err_info="C:/MonkeyX77a/modules/mgev2/tests/lineintersection test.monkey<69>";
		bb_graphics_DrawCircle(dbg_object(dbg_object(this.m_a).m_intersection).m_x,dbg_object(dbg_object(this.m_a).m_intersection).m_y,3.0);
	}
	err_info="C:/MonkeyX77a/modules/mgev2/tests/lineintersection test.monkey<70>";
	bb_graphics_DrawText("LMB: rotate to counter-clockwise",2.0,2.0,0.0,0.0);
	err_info="C:/MonkeyX77a/modules/mgev2/tests/lineintersection test.monkey<71>";
	bb_graphics_DrawText("RMB: rotate to clockwise",2.0,14.0,0.0,0.0);
	err_info="C:/MonkeyX77a/modules/mgev2/tests/lineintersection test.monkey<72>";
	bb_graphics_DrawText("Distance: "+String(this.m_distance),2.0,26.0,0.0,0.0);
	err_info="C:/MonkeyX77a/modules/mgev2/tests/lineintersection test.monkey<74>";
	pop_err();
	return 0;
}
c_Game.prototype.p_OnLoading=function(){
	push_err();
	err_info="C:/MonkeyX77a/modules/mgev2/tests/lineintersection test.monkey<80>";
	pop_err();
	return 0;
}
c_Game.prototype.p_OnSuspend=function(){
	push_err();
	err_info="C:/MonkeyX77a/modules/mgev2/tests/lineintersection test.monkey<94>";
	pop_err();
	return 0;
}
c_Game.prototype.p_OnResume=function(){
	push_err();
	err_info="C:/MonkeyX77a/modules/mgev2/tests/lineintersection test.monkey<100>";
	pop_err();
	return 0;
}
c_Game.prototype.p_OnClose=function(){
	push_err();
	err_info="C:/MonkeyX77a/modules/mgev2/tests/lineintersection test.monkey<109>";
...
c_Game.prototype.p_OnBack=function(){
	push_err();
	err_info="C:/MonkeyX77a/modules/mgev2/tests/lineintersection test.monkey<115>";
...
function bbMain(){
	push_err();
	err_info="C:/MonkeyX77a/modules/mgev2/tests/lineintersection test.monkey<6>";
	c_Game.m_new.call(new c_Game);
	err_info="C:/MonkeyX77a/modules/mgev2/tests/lineintersection test.monkey<7>";
	pop_err();
	return 0;
}
...
function c_Segment(){
	...
	this.m_localTemp=c_Vector.m_new.call(new c_Vector,0.0,0.0);
	this.m_vec=c_Vector.m_new.call(new c_Vector,0.0,0.0);
}
...
c_Segment.prototype.p_Set=function(t_x1,t_y1,t_x2,t_y2){
	push_err();
	err_info="C:/MonkeyX77a/modules/mgev2/src/utils/geom/segment.monkey<33>";
	this.m_p1.p_Set4(t_x1,t_y1);
	err_info="C:/MonkeyX77a/modules/mgev2/src/utils/geom/segment.monkey<34>";
	this.m_p2.p_Set4(t_x2,t_y2);
	err_info="C:/MonkeyX77a/modules/mgev2/src/utils/geom/segment.monkey<35>";
	pop_err();
	return this;
}
c_Segment.prototype.p_Set2=function(t_v1,t_v2){
	push_err();
	err_info="C:/MonkeyX77a/modules/mgev2/src/utils/geom/segment.monkey<39>";
	this.m_p1.p_Set5(t_v1);
	err_info="C:/MonkeyX77a/modules/mgev2/src/utils/geom/segment.monkey<40>";
	this.m_p2.p_Set5(t_v2);
	err_info="C:/MonkeyX77a/modules/mgev2/src/utils/geom/segment.monkey<41>";
	pop_err();
	return this;
}
c_Segment.prototype.p_Set3=function(t_seg){
	push_err();
	err_info="C:/MonkeyX77a/modules/mgev2/src/utils/geom/segment.monkey<45>";
	this.p_Set2(dbg_object(t_seg).m_p1,dbg_object(t_seg).m_p2);
	err_info="C:/MonkeyX77a/modules/mgev2/src/utils/geom/segment.monkey<46>";
	pop_err();
	return this;
}
c_Segment.prototype.p_IntersectSegment=function(t_other){
	push_err();
	err_info="C:/MonkeyX77a/modules/mgev2/src/utils/geom/segment.monkey<117>";
	...
	err_info="C:/MonkeyX77a/modules/mgev2/src/utils/geom/segment.monkey<118>";
	...
	err_info="C:/MonkeyX77a/modules/mgev2/src/utils/geom/segment.monkey<120>";
	if(t_rd==0.0){
		err_info="C:/MonkeyX77a/modules/mgev2/src/utils/geom/segment.monkey<121>";
		pop_err();
		return false;
	}else{
		err_info="C:/MonkeyX77a/modules/mgev2/src/utils/geom/segment.monkey<123>";
		...
		err_info="C:/MonkeyX77a/modules/mgev2/src/utils/geom/segment.monkey<124>";
		var t_intersection_AB=t_rn/t_rd;
		err_info="C:/MonkeyX77a/modules/mgev2/src/utils/geom/segment.monkey<125>";
		var t_intersection_CD=t_sn/t_rd;
		err_info="C:/MonkeyX77a/modules/mgev2/src/utils/geom/segment.monkey<127>";
		if(t_intersection_AB>1.0 || t_intersection_CD>1.0 || t_intersection_AB<0.0 || t_intersection_CD<0.0){
			err_info="C:/MonkeyX77a/modules/mgev2/src/utils/geom/segment.monkey<127>";
			pop_err();
			return false;
		}
		err_info="C:/MonkeyX77a/modules/mgev2/src/utils/geom/segment.monkey<129>";
		...
		err_info="C:/MonkeyX77a/modules/mgev2/src/utils/geom/segment.monkey<130>";
		...
		err_info="C:/MonkeyX77a/modules/mgev2/src/utils/geom/segment.monkey<132>";
		pop_err();
		return true;
	}
}
c_Segment.prototype.p_Intersects=function(t_shape){
	push_err();
	err_info="C:/MonkeyX77a/modules/mgev2/src/utils/geom/segment.monkey<105>";
	if((object_downcast((t_shape),c_Rectangle))!=null){
		err_info="C:/MonkeyX77a/modules/mgev2/src/utils/geom/segment.monkey<106>";
		var t_=object_downcast((t_shape),c_Rectangle).p_IntersectSegment(this);
		pop_err();
		return t_;
	}else{
		err_info="C:/MonkeyX77a/modules/mgev2/src/utils/geom/segment.monkey<107>";
		if((object_downcast((t_shape),c_Circle))!=null){
			err_info="C:/MonkeyX77a/modules/mgev2/src/utils/geom/segment.monkey<108>";
			var t_2=object_downcast((t_shape),c_Circle).p_IntersectSegment(this);
			pop_err();
			return t_2;
		}else{
			err_info="C:/MonkeyX77a/modules/mgev2/src/utils/geom/segment.monkey<109>";
			if((object_downcast((t_shape),c_Segment))!=null){
				err_info="C:/MonkeyX77a/modules/mgev2/src/utils/geom/segment.monkey<110>";
				var t_3=this.p_IntersectSegment(object_downcast((t_shape),c_Segment));
				pop_err();
				return t_3;
			}
		}
	}
	err_info="C:/MonkeyX77a/modules/mgev2/src/utils/geom/segment.monkey<113>";
	pop_err();
	return false;
}
c_Segment.prototype.p_GetClosestPoint=function(t_point,t_result){
	push_err();
	err_info="C:/MonkeyX77a/modules/mgev2/src/utils/geom/segment.monkey<70>";
	this.m_localTemp=c_Vector.m_MakeBetween(t_point,this.m_p1);
	err_info="C:/MonkeyX77a/modules/mgev2/src/utils/geom/segment.monkey<71>";
	this.m_vec=c_Vector.m_MakeBetween(this.m_p2,this.m_p1);
	err_info="C:/MonkeyX77a/modules/mgev2/src/utils/geom/segment.monkey<73>";
	var t_amt=this.m_vec.p_ProjectionAmount(this.m_localTemp);
	err_info="C:/MonkeyX77a/modules/mgev2/src/utils/geom/segment.monkey<75>";
	t_amt=bb_math2_Min2(1.0,bb_math2_Max2(0.0,t_amt));
	err_info="C:/MonkeyX77a/modules/mgev2/src/utils/geom/segment.monkey<77>";
	t_result.p_Set5(this.m_p1.p_Add2(this.m_vec.p_Multiply2(t_amt)));
	pop_err();
}
c_Segment.prototype.p_DistanceTo=function(t_point){
	push_err();
	err_info="C:/MonkeyX77a/modules/mgev2/src/utils/geom/segment.monkey<81>";
	var t_closest=c_Vector.m_new.call(new c_Vector,0.0,0.0);
	err_info="C:/MonkeyX77a/modules/mgev2/src/utils/geom/segment.monkey<83>";
	this.p_GetClosestPoint(t_point,t_closest);
	err_info="C:/MonkeyX77a/modules/mgev2/src/utils/geom/segment.monkey<85>";
	var t_=t_point.p_DistanceTo(t_closest);
	pop_err();
	return t_;
}
c_Segment.prototype.p_DistanceTo2=function(t_other){
	push_err();
	err_info="C:/MonkeyX77a/modules/mgev2/src/utils/geom/segment.monkey<89>";
	var t_closest1=c_Vector.m_new.call(new c_Vector,0.0,0.0);
	err_info="C:/MonkeyX77a/modules/mgev2/src/utils/geom/segment.monkey<90>";
	var t_closest2=c_Vector.m_new.call(new c_Vector,0.0,0.0);
	err_info="C:/MonkeyX77a/modules/mgev2/src/utils/geom/segment.monkey<92>";
	this.p_GetClosestPoint(dbg_object(t_other).m_p1,t_closest1);
	err_info="C:/MonkeyX77a/modules/mgev2/src/utils/geom/segment.monkey<93>";
	this.p_GetClosestPoint(dbg_object(t_other).m_p2,t_closest2);
	err_info="C:/MonkeyX77a/modules/mgev2/src/utils/geom/segment.monkey<95>";
	var t_dist1=t_other.p_DistanceTo(t_closest1);
	err_info="C:/MonkeyX77a/modules/mgev2/src/utils/geom/segment.monkey<96>";
	var t_dist2=t_other.p_DistanceTo(t_closest2);
	err_info="C:/MonkeyX77a/modules/mgev2/src/utils/geom/segment.monkey<98>";
	if(t_dist1>t_dist2){
		err_info="C:/MonkeyX77a/modules/mgev2/src/utils/geom/segment.monkey<98>";
		pop_err();
		return t_dist2;
	}
	err_info="C:/MonkeyX77a/modules/mgev2/src/utils/geom/segment.monkey<99>";
	if(t_dist1<t_dist2){
		err_info="C:/MonkeyX77a/modules/mgev2/src/utils/geom/segment.monkey<99>";
		pop_err();
		return t_dist1;
	}
	err_info="C:/MonkeyX77a/modules/mgev2/src/utils/geom/segment.monkey<101>";
	var t_=bb_math2_Min2(t_dist1,t_dist2);
	pop_err();
	return t_;
}
function c_Vector(){
...
c_Vector.prototype.p_Set4=function(t_x,t_y){
	push_err();
...
c_Vector.prototype.p_Set5=function(t_other){
	push_err();
	err_info="C:/MonkeyX77a/modules/mgev2/src/utils/math/vector.monkey<26>";
	var t_=this.p_Set4(dbg_object(t_other).m_x,dbg_object(t_other).m_y);
	pop_err();
	return t_;
}
...
c_Vector.prototype.p_Length2=function(t_value){
	...
	if(this.p_Length()>0.0){
		...
		this.p_Set5(this.p_Multiply2(t_value/this.p_Length()));
	}else{
...
c_Rectangle.prototype.p_IntersectSegment=function(t_segment){
	push_err();
	err_info="C:/MonkeyX77a/modules/mgev2/src/utils/geom/rectangle.monkey<92>";
	pop_err();
	return false;
}
function c_Circle(){
...
c_Circle.prototype.p_IntersectSegment=function(t_segment){
	push_err();
	err_info="C:/MonkeyX77a/modules/mgev2/src/utils/geom/circle.monkey<68>";
	var t_circleToLine=c_Vector.m_MakeBetween(this.m_position,dbg_object(t_segment).m_p1);
	err_info="C:/MonkeyX77a/modules/mgev2/src/utils/geom/circle.monkey<69>";
	var t_line=c_Vector.m_MakeBetween(dbg_object(t_segment).m_p2,dbg_object(t_segment).m_p1);
	err_info="C:/MonkeyX77a/modules/mgev2/src/utils/geom/circle.monkey<71>";
	var t_amt=t_line.p_ProjectionAmount(t_circleToLine);
	err_info="C:/MonkeyX77a/modules/mgev2/src/utils/geom/circle.monkey<73>";
	t_amt=bb_math2_Min2(1.0,bb_math2_Max2(0.0,t_amt));
	err_info="C:/MonkeyX77a/modules/mgev2/src/utils/geom/circle.monkey<75>";
	this.m_projection=c_Vector.m_new2.call(new c_Vector,dbg_object(t_segment).m_p1.p_Add2(t_line.p_Multiply2(t_amt)));
	err_info="C:/MonkeyX77a/modules/mgev2/src/utils/geom/circle.monkey<77>";
	var t_distance=this.m_projection.p_DistanceTo(this.m_position);
	err_info="C:/MonkeyX77a/modules/mgev2/src/utils/geom/circle.monkey<79>";
